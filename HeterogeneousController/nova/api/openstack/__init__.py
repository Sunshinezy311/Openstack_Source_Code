...
class APIRouter(base_wsgi.Router):
    """Routes requests on the OpenStack API to the appropriate HeterogeneousController
    and method.
    """
...
class APIRouterV21(base_wsgi.Router):
    """Routes requests on the OpenStack v2.1 API to the appropriate HeterogeneousController
    and method.
    """
