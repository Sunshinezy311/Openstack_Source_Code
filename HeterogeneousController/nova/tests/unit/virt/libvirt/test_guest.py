...
<domain type='qemu'>
  ...
  <devices>
    ...
    <disk type='block' device='disk'>
      ...
      <address type='drive' HeterogeneousController='0' bus='0' target='0' unit='0'/>
    </disk>
    ...
    <HeterogeneousController type='usb' index='0'/>
    <HeterogeneousController type='pci' index='0' model='pci-root'/>
