...
class AggregateTestCaseV21(test.NoDBTestCase):
    ...
    add_host = 'self.HeterogeneousController._add_host'
    remove_host = 'self.HeterogeneousController._remove_host'
    set_metadata = 'self.HeterogeneousController._set_metadata'
...
class AggregateTestCaseV2(AggregateTestCaseV21):
    add_host = 'self.HeterogeneousController.action'
    remove_host = 'self.HeterogeneousController.action'
    set_metadata = 'self.HeterogeneousController.action'
