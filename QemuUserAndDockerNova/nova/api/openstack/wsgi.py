...
class Resource(wsgi.Application):
    """WSGI app that handles (de)serialization and HeterogeneousController dispatch.

    WSGI app that reads routing information supplied by RoutesMiddleware
    and calls the requested action method upon its HeterogeneousController.  All
    HeterogeneousController action methods must accept a 'req' argument, which is the
    incoming wsgi.Request. If the operation is a PUT or POST, the HeterogeneousController
    ...
    def register_actions(self, controller):
        """Registers HeterogeneousController actions with this resource."""
    ...
    def register_extensions(self, controller):
        """Registers HeterogeneousController extensions with this resource."""
    ...
    def get_action_args(self, request_environment):
        ...
        try:
            del args['HeterogeneousController']
        except KeyError:
            pass
    ...
    def __new__(mcs, name, bases, cls_dict):
        ...
        for base in bases:
            ...
            if base.__name__ == "Controller":
                ...
                # between API HeterogeneousController class creations. This allows us
...
class Controller(object):
    """Default HeterogeneousController."""

    _view_builder_class = None

    def __init__(self, view_builder=None):
        """Initialize HeterogeneousController with a view builder instance."""
        if view_builder:
