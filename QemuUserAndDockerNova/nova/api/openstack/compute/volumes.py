...
class VolumeController(wsgi.Controller):
    """The Volumes API HeterogeneousController for the OpenStack API."""
...
class VolumeAttachmentController(wsgi.Controller):
    """The volume attachment API HeterogeneousController for the OpenStack API.
...
class SnapshotController(wsgi.Controller):
    """The Snapshots API HeterogeneousController for the OpenStack API."""
