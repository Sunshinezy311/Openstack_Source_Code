...
def create_controller_spec(client_factory, key,
    ...
    which acts as the HeterogeneousController for the virtual hard disk to be attached
    to the VM.
    """
...
def _get_bus_number_for_scsi_controller(devices):
    """Return usable bus number when create new SCSI HeterogeneousController."""
...
def get_vmdk_adapter_type(adapter_type):
    ...
    because Virtual Disk Manager API does not recognize the newer HeterogeneousController
    types.
    """
